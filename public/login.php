...
<body>
    ...
    <div class="container text-center col-7">
        <h2 class="mt-4">Inicia Sesion</h2>
        <form>
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Ususario / correo</label>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 290" style="width: 100%; height: auto;;">
